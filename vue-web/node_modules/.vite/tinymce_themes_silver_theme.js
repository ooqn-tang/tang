  ...
  "node_modules/tinymce/themes/silver/theme.js"() {
    (function() {
      ...
      const nu$9 = (parts2) => {
        ...
        return __spreadValues(__spreadValues({}, defaultEventHandler), parts2);
      };
      ...
      const merge = (defnA, mod) => __spreadProps(__spreadValues({}, defnA), {
        attributes: __spreadValues(__spreadValues({}, defnA.attributes), mod.attributes),
        styles: __spreadValues(__spreadValues({}, defnA.styles), mod.styles),
        classes: defnA.classes.concat(mod.classes)
      });
      const combine$2 = (info, baseMod, behaviours2, base2) => {
        const modsByBehaviour = __spreadValues({}, baseMod);
        ...
        const combineObjects = (objects) => foldr(objects, (b2, a) => __spreadValues(__spreadValues({}, a.modification), b2), {});
      ...
      const groupByEvents = (info, behaviours2, base2) => {
        const behaviourEvents = __spreadValues(__spreadValues({}, base2), nameToHandlers(behaviours2, info));
      ...
      const toDefinition = (detail) => __spreadProps(__spreadValues({}, detail.dom), {
        uid: detail.uid,
      ...
      const reconcileToDom = (definition, obsoleted) => {
        const _a = clone$1(obsoleted), {
          class: clazz,
          style
        } = _a, existingAttributes = __objRest(_a, [
          "class",
          "style"
        ]);
        const {
      ...
      const buildFromSpec = (userSpec, obsoleted) => {
        const _a = make$8(userSpec), {
          events: specEvents
        } = _a, spec = __objRest(_a, [
          "events"
        ]);
        const components2 = buildSubcomponents(spec, obsoleted);
        const completeSpec = __spreadProps(__spreadValues({}, spec), {
          events: __spreadValues(__spreadValues({}, DefaultEvents), specEvents),
      ...
      const buildOrPatch = (spec, obsoleted) => getPremade(spec).getOrThunk(() => {
        const userSpecWithUid = isSketchSpec$1(spec) ? spec : __spreadValues({
          uid: uids("")
        }, spec);
      ...
      const doCreate = (configSchema, schemaSchema, name2, active2, apis, extra, state) => {
        ...
        const me = __spreadProps(__spreadValues(__spreadValues({}, wrappedExtra), wrappedApis), {
      ...
      const toOptions = (position2) => __spreadProps(__spreadValues({}, position2), {
      ...
      const value$2 = () => {
        ...
        return __spreadProps(__spreadValues({}, subject), {
          on: on2
        });
      };
      const filter = always;
      ...
      const applyTransitionCss = (element2, origin, position2, transition, decision, lastPlacement) => {
        ...
        if (shouldTransition || isTransitioning$1(element2, transition)) {
          ...
          const intermediatePosition = reposition(origin, __spreadProps(__spreadValues({}, decision), {
            rect: rect2
          }));
      ...
      const dataset = () => {
        ...
        const update = (items) => {
          ...
          dataByValue.set(__spreadValues(__spreadValues({}, currentDataByValue), newDataByValue));
          dataByText.set(__spreadValues(__spreadValues({}, currentDataByText), newDataByText));
        };
        return nu$8({
          readState,
          lookup: lookup2,
      ...
      const augment = (data, original2) => __spreadValues(__spreadValues({}, derive$1(original2)), data.dump);
      ...
      const supplyUid = (spec) => {
        return hasUid(spec) ? spec : __spreadProps(__spreadValues({}, spec), {
          uid: generate$5("uid")
        });
      };
      ...
      const withGrid = (values2, index, numCols, f) => {
      ...
      const getTogglingSpec = (tConfig) => __spreadProps(__spreadValues({
        aria: { mode: "checked" }
      ...
      const builder$2 = (detail) => ({
        dom: detail.dom,
        domModification: __spreadProps(__spreadValues({}, detail.domModification), {
          attributes: __spreadValues(__spreadProps(__spreadValues({
      ...
      const parts$g = constant$1([group({
        ...
        unit: "item",
        defaults: (detail, u) => {
          return has$2(u, "uid") ? u : __spreadProps(__spreadValues({}, u), {
            uid: generate$5("item")
          });
        },
        overrides: (detail, u) => {
      ...
      const init$c = () => {
        ...
        const setMenuBuilt = (menuName, built) => {
          menus.set(__spreadProps(__spreadValues({}, menus.get()), {
            [menuName]: {
              type: "prepared",
              menu: built
            }
      ...
      const make$6 = (detail, _rawUiSpec) => {
        ...
        const buildMenus = (container, primaryName, menus) => map$1(menus, (spec, name2) => {
          const makeSketch = () => Menu.sketch(__spreadProps(__spreadValues({}, spec), {
            value: name2,
            markers: detail.markers,
      ...
      const factory$m = (detail, spec) => {
        ...
        return {
          ...
          behaviours: augment(detail.inlineBehaviours, [
            ...
            Receiving.config({
              channels: __spreadValues(__spreadValues({}, receivingChannel$1(__spreadValues({
                isExtraPart: spec.isExtraPart
              }, detail.fireDismissalEventInstead.map((fe) => ({ fireEventInstead: { event: fe.event } })).getOr({})))), receivingChannel(__spreadProps(__spreadValues({}, detail.fireRepositionEventInstead.map((fe) => ({ fireEventInstead: { event: fe.event } })).getOr({})), {
      ...
      const record = (spec) => {
        ...
        const asSpec = () => __spreadProps(__spreadValues({}, spec), {
          uid
        });
        return {
          get: get2,
      ...
      var NotificationManagerImpl = (editor, extras, uiMothership) => {
        ...
        const open2 = (settings, closeCallback) => {
          ...
          const notificationWrapper = build$1(InlineView.sketch(__spreadValues({
            dom: {
              tag: "div",
          ...
          const reposition2 = () => {
            ...
            if (allNotifications[0] === thisNotification) {
              const anchor2 = __spreadProps(__spreadValues({}, sharedBackstage.anchors.banner()), {
      ...
      const getMenus = (editor) => {
        ...
        return map$1(menu2, (menu3) => __spreadProps(__spreadValues({}, menu3), {
          items: menu3.items
        }));
      };
      ...
      const renderColorStructure = (item2, providerBackstage, fallbackIcon) => {
        ...
        const getDom = () => {
          ...
          if (itemValue === colorPickerCommand) {
            return __spreadProps(__spreadValues({}, baseDom), {
              tag: "button",
              classes: [
                ...baseDom.classes,
            ...
            return __spreadProps(__spreadValues({}, baseDom), {
              attributes: __spreadProps(__spreadValues({}, baseDom.attributes), {
      ...
      const renderColorSwatchItem = (spec, backstage) => {
        ...
        const widgetSpec = __spreadProps(__spreadValues({}, menuSpec), {
          markers: markers(presets),
      ...
      const createMenuItemFromBridge = (item2, itemResponse, backstage, menuHasIcons2, isHorizontalMenu) => {
        ...
        const parseForHorizontalMenu = (menuitem) => !isHorizontalMenu ? menuitem : __spreadProps(__spreadValues({}, menuitem), {
      ...
      const createAutocompleteItems = (items, matchText, onItemValueHandler, columns, itemResponse, sharedBackstage, highlightOn) => {
        ...
        return cat(map$2(items, (item2) => {
          switch (item2.type) {
            ...
            case "cardmenuitem":
              return createCardMenuItem(item2).fold(handleError, (d) => Optional.some(card(__spreadProps(__spreadValues({}, d), {
                onAction: (api2) => {
                  d.onAction(api2);
      ...
      const createPartialMenu = (value2, items, itemResponse, backstage, isHorizontalMenu) => {
        ...
        const alloyItems = cat(map$2(items, (item2) => {
          ...
          if (item2.type === "nestedmenuitem" && item2.getSubmenuItems().length <= 0) {
            return createItem(__spreadProps(__spreadValues({}, item2), {
              enabled: false
            }));
          } else {
      ...
      const createInlineMenuFrom = (partialMenu, columns, focusMode, presets) => {
        ...
        const menuMarkers = markers(presets);
        return {
          data: createTieredDataFrom(__spreadProps(__spreadValues({}, partialMenu), {
            movement,
      ...
      const factory$j = (detail) => {
        const _a = detail.dom, { attributes } = _a, domWithoutAttributes = __objRest(_a, ["attributes"]);
        return {
          uid: detail.uid,
          dom: __spreadValues({
            tag: "div",
      ...
      const behaviours = (detail) => __spreadValues(__spreadValues({}, focusBehaviours(detail)), augment(detail.inputBehaviours, [Representing.config({
        store: __spreadProps(__spreadValues({
          mode: "manual"
      ...
      const openF = (detail, mapFetch, anchor2, component, sandbox, externals, highlightOnOpen) => {
        ...
        return futureData.map((tdata) => tdata.bind((data) => Optional.from(tieredMenu.sketch(__spreadProps(__spreadValues({}, externals.menu()), {
          uid: generate$5(""),
          data,
      ...
      const makeSandbox$1 = (detail, hotspot, extras) => {
        ...
        return {
          ...
          behaviours: SketchBehaviours.augment(detail.sandboxBehaviours, [
            ...
            Receiving.config({
              channels: __spreadValues(__spreadValues({}, receivingChannel$1({ isExtraPart: never })), receivingChannel({ doReposition: doRepositionMenus }))
            })
          ])
        };
      };
      ...
      const factory$g = (detail, components2, _spec, externals) => {
        ...
        return {
          ...
          eventOrder: __spreadProps(__spreadValues({}, detail.eventOrder), {
            [execute$5()]: [
              "disabling",
              "toggling",
              "alloy.base.behaviour"
          ...
          domModification: {
            attributes: __spreadValues(__spreadValues({
              "aria-haspopup": "true"
            }, detail.role.fold(() => ({}), (role) => ({ role }))), detail.dom.tag === "button" ? { type: lookupAttr("type").getOr("button") } : {})
          }
        };
      };
      ...
      const rgbFormFactory = (translate2, getClass, onValidHexx, onInvalidHexx) => {
        ...
        const renderTextField2 = (isValid, name2, label2, description, data) => {
          ...
          const pField = FormField.parts.field({
            data,
            factory: Input,
            inputAttributes: __spreadValues({
              type: "text"
      ...
      const renderIFrame = (spec, providersBackstage, initialData) => {
        ...
        const attributes = __spreadValues(__spreadValues(__spreadValues({}, spec.label.map((title2) => ({ title: title2 })).getOr({})), initialData.map((html) => ({ srcdoc: html })).getOr({})), isSandbox ? { sandbox: "allow-scripts allow-same-origin" } : {});
      ...
      const renderCommonDropdown = (spec, prefix2, sharedBackstage) => {
        ...
        const memDropdown = record(Dropdown.sketch(__spreadProps(__spreadValues(__spreadValues({}, spec.uid ? { uid: spec.uid } : {}), role), {
          dom: {
            tag: "button",
            classes: [
              prefix2,
            ...
            attributes: __spreadValues({}, tooltipAttributes)
          },
      ...
      const renderSelectBox = (spec, providersBackstage, initialData) => {
        ...
        const pLabel = spec.label.map((label2) => renderLabel$2(label2, providersBackstage));
        const pField = FormField.parts.field(__spreadProps(__spreadValues({
          dom: {}
      ...
      const renderTextField = (spec, providersBackstage) => {
        ...
        const inputAttributes = __spreadValues(__spreadValues({}, placeholder2), inputMode);
        const pField = FormField.parts.field(__spreadProps(__spreadValues({
      ...
      const make$3 = (detail, components2, spec, externals) => {
        ...
        return {
          ...
          behaviours: __spreadValues(__spreadValues({}, focusBehaviours$1), augment(detail.typeaheadBehaviours, behaviours2)),
          eventOrder: detail.eventOrder
        };
      };
      ...
      const renderFooterButton = (spec, buttonType, backstage) => {
        if (isMenuFooterButtonSpec(spec, buttonType)) {
          ...
          const fixedSpec = __spreadProps(__spreadValues({}, spec), {
            onSetup: (api2) => {
          ...
          const buttonSpec = __spreadProps(__spreadValues({}, spec), {
            borderless: false
          });
      ...
      const renderDialogButton = (spec, providersBackstage) => {
        ...
        return renderFormField(Optional.none(), FormField.parts.field(__spreadValues({
          factory: Button
      ...
      const SlotContainer = __spreadValues(__spreadValues({}, slotApis), { sketch });
        ...
        return {
          ...
          behaviours: derive$1([
            ...
            Receiving.config({
              channels: __spreadValues(__spreadValues({}, receivingChannel$1(__spreadValues({
                isExtraPart: never
              }, detail.fireDismissalEventInstead.map((fe) => ({ fireEventInstead: { event: fe.event } })).getOr({})))), receivingChannel({
                doReposition: () => {
      ...
      const factory$a = (detail, components2, spec, externals) => __spreadProps(__spreadValues({}, Button.sketch(__spreadProps(__spreadValues({}, externals.button()), {
        action: (button2) => {
      ...
      const factory$8 = (detail, components2, spec, externals) => {
        ...
        return {
          ...
          behaviours: augment(detail.splitToolbarBehaviours, [Coupling.config({
            others: {
              overflowGroup: () => {
                return ToolbarGroup.sketch(__spreadProps(__spreadValues({}, externals["overflow-group"]()), {
            ...
            Coupling.config({
              others: {
                overflowGroup: (toolbar) => {
                  return ToolbarGroup.sketch(__spreadProps(__spreadValues({}, externals["overflow-group"]()), {
                    items: [Button.sketch(__spreadProps(__spreadValues({}, externals["overflow-button"]()), {
                      action: (_button) => {
      ...
      const renderFloatingMoreToolbar = (toolbarSpec) => {
        ...
        return SplitFloatingToolbar.sketch(__spreadProps(__spreadValues({}, baseSpec), {
          ...
          parts: __spreadProps(__spreadValues({}, baseSpec.parts), {
            overflow: {
              dom: {
                tag: "div",
      ...
      const renderSlidingMoreToolbar = (toolbarSpec) => {
        ...
        const baseSpec = renderMoreToolbarCommon(toolbarSpec);
        return SplitSlidingToolbar.sketch(__spreadProps(__spreadValues({}, baseSpec), {
          components: [
            primary2,
            overflow2
          ],
      ...
      const identifyMenus = (editor, registry) => {
        const rawMenuData = __spreadValues(__spreadValues({}, defaultMenus), registry.menus);
      ...
      const generateSelectItems = (_editor, backstage, spec) => {
        const generateItem = (rawItem, response, invalid, value2) => {
          ...
          if (rawItem.type === "separator") {
            ...
            return Optional.some(__spreadValues({
              type: "togglemenuitem",
              text: translatedText,
              icon: rawItem.icon,
      ...
      const factory$5 = (detail, components2, spec, externals) => {
        ...
        const buttonEvents = __spreadValues(__spreadValues({}, derive$2([runOnAttached((component, _simulatedEvent) => {
      ...
      const renderContextButton = (memInput, button2, extras) => {
        const _a = button2.original, { primary: primary2 } = _a, rest = __objRest(_a, ["primary"]);
        const bridged = getOrDie(createToolbarButton(__spreadProps(__spreadValues({}, rest), {
          type: "button",
          onAction: noop
        })));
      ...
      const renderContextToggleButton = (memInput, button2, extras) => {
        const _a = button2.original, { primary: primary2 } = _a, rest = __objRest(_a, ["primary"]);
        const bridged = getOrDie(createToggleButton(__spreadProps(__spreadValues({}, rest), {
          type: "togglebutton",
          onAction: noop
        })));
      ...
      const getAnchorSpec$2 = (editor, mobile, data, position2) => {
        const smartInsetLayout = (elem) => (anchor2, element2, bubbles, placee, bounds2) => {
          ...
          const newAnchor = __spreadProps(__spreadValues({}, anchor2), {
            y: bounds2.y,
            height: bounds2.height
          });
          return __spreadProps(__spreadValues({}, layout2(newAnchor, element2, bubbles, placee, bounds2)), {
            alwaysFit: true
          });
        };
        ...
        if (toolbars.length <= 1) {
          ...
          if (hasSelectionToolbars || hasNodeToolbars) {
            if (hasNodeToolbars && hasSelectionToolbars) {
              ...
              const selectionToolbars = map$2(filterToolbarsByPosition("selection"), (t2) => __spreadProps(__spreadValues({}, t2), {
                position: "node"
              }));
      ...
      const categorise = (contextToolbars, navigate) => {
        ...
        const registerForm = (key, toolbarSpec) => {
          ...
          contextForm.launch.map((launch) => {
            formNavigators["form:" + key + ""] = __spreadProps(__spreadValues({}, toolbarSpec.launch), {
      ...
      const register$9 = (editor, registryContextToolbars, sink, extras) => {
        ...
        const buildToolbar = (toolbars) => {
          ...
          const allButtons = __spreadValues(__spreadValues({}, buttons), scopes.formNavigators);
      ...
      const setup$3 = (editor) => {
        ...
        const makeHeaderPart = () => {
          ...
          const partToolbar2 = OuterContainer.parts.toolbar(__spreadValues({
            dom: {
              tag: "div",
              classes: ["tox-toolbar"]
            },
        ...
        const renderSink = () => {
          ...
          const sinkSpec = {
            dom: {
              ...
              attributes: __spreadValues({}, global$8.isRtl() ? { dir: "rtl" } : {})
            },
        ...
        const renderContainer2 = () => {
          ...
          const attributes = __spreadValues(__spreadValues({
            role: "application"
          }, global$8.isRtl() ? { dir: "rtl" } : {}), isHidden2 ? { "aria-hidden": "true" } : {});
      ...
      const parts$2 = constant$1([
        ...
        external({
          factory: {
            sketch: (spec, detail) => __spreadProps(__spreadValues({}, spec), {
              dom: detail.dom,
              components: detail.components
            })
          },
      ...
      const factory$4 = (detail, components2, spec, externals) => {
        ...
        const showDialog = (dialog) => {
          ...
          const blocker = sink.getSystem().build(__spreadProps(__spreadValues({}, externalBlocker), {
        ...
        const eventOrder = __spreadProps(__spreadValues({}, detail.eventOrder), {
      ...
      const renderBody = (spec, dialogId, contentId, backstage, ariaAttrs) => {
        ...
        return {
          dom: {
            ...
            attributes: __spreadValues(__spreadValues({}, contentId.map((x) => ({ id: x })).getOr({})), ariaAttrs ? ariaAttributes : {})
          },
          components: [],
          behaviours: derive$1([
            ComposingConfigs.childAt(0),
      ...
      const renderTitle = (spec, dialogId, titleId, providersBackstage) => {
        ...
        return {
          dom: {
            tag: "div",
            classes: ["tox-dialog__title"],
            attributes: __spreadValues({}, titleId.map((x) => ({ id: x })).getOr({}))
          },
          components: [],
      ...
      const renderModalDialog = (spec, initialData, dialogEvents, backstage) => {
        ...
        return build$1(renderDialog$1(__spreadProps(__spreadValues({}, spec), {
          lazySink: backstage.shared.getSink,
          extraBehaviours: [
            Reflecting.config({
      ...
      const mapMenuButtons = (buttons) => {
        const mapItems = (button2) => {
          ...
          return __spreadProps(__spreadValues({}, button2), {
            items
          });
        };
      ...
      const getDialogApi = (access, doRedial, menuItemStates) => {
        ...
        const getData2 = () => {
          ...
          return __spreadValues(__spreadValues({}, representedValues), menuItemCurrentState);
        };
      ...
      const renderUrlDialog = (internalDialog, extra, editor, backstage) => {
        ...
        const styles = __spreadValues(__spreadValues({}, internalDialog.height.fold(() => ({}), (height2) => ({
          "height": height2 + "px",
      ...
      const setup = (extras) => {
        ...
        const openInlineDialog = (config$1, anchor2, closeWindow, ariaAttrs) => {
          const factory2 = (contents2, internalInitialData, dataValidator) => {
            ...
            const inlineDialogComp = build$1(InlineView.sketch(__spreadProps(__spreadValues({
              lazySink: backstage.shared.getSink,
              dom: {
                tag: "div",
                classes: []
...
// dep:tinymce_themes_silver_theme
var tinymce_themes_silver_theme_default = require_theme();
export {
  tinymce_themes_silver_theme_default as default
};
