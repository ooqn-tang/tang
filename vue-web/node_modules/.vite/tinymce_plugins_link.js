  ...
  "node_modules/tinymce/plugins/link/plugin.js"() {
    (function() {
      ...
      const applyLinkOverrides = (editor, linkAttrs) => {
        const newLinkAttrs = __spreadValues({}, linkAttrs);
      ...
      const init = (initialData, linkCatalog) => {
        ...
        const onUrlChange = (data) => {
          ...
          if (text.isSome() || title.isSome()) {
            return Optional.some(__spreadValues(__spreadValues({}, text.map((text2) => ({ text: text2 })).getOr({})), title.map((title2) => ({ title: title2 })).getOr({})));
          } else {
            return Optional.none();
          }
        };
      ...
      const tryEmailTransform = (data) => {
        ...
        return suggestMailTo ? Optional.some({
          ...
          preprocess: (oldData) => __spreadProps(__spreadValues({}, oldData), {
            href: "mailto:" + url
          })
        }) : Optional.none();
      };
