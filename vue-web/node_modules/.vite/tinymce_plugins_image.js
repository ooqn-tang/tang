  ...
  "node_modules/tinymce/plugins/image/plugin.js"() {
    (function() {
      ...
      const create = (normalizeCss2, data) => {
        const image = document.createElement("img");
        write(normalizeCss2, __spreadProps(__spreadValues({}, data), {
          caption: false
        }), image);
      ...
      const insertOrUpdateImage = (editor, partialData) => {
        ...
        if (image) {
          ...
          const data = __spreadValues(__spreadValues({}, selectedImageData), partialData);
          ...
          insertImageAtCaret(editor, __spreadValues(__spreadValues({}, defaultData()), partialData));
        }
      };
      const deep = (old, nu) => {
      ...
      const makeItems = (info) => {
        ...
        return flatten([
          ...
          [__spreadProps(__spreadValues({}, getDialogContainerType(info.classList.isSome() && info.hasImageCaption)), {
            items: flatten([
              classList.toArray(),
      ...
      const submitHandler = (editor, info, helpers) => (api) => {
        ...
        const finalData = __spreadProps(__spreadValues({}, data), {
