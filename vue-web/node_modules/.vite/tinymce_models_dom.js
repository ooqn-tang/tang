  ...
  "node_modules/tinymce/models/dom/model.js"() {
    (function() {
      ...
      const onPaste = (warehouse, target) => cell(target.element).bind((cell2) => findInWarehouse(warehouse, cell2).map((details) => {
        const value2 = __spreadProps(__spreadValues({}, details), {
      ...
      const merge$1 = (startAddress, gridA, gridB, generator, comparator) => {
        ...
        return result.map((diff) => {
          const delta = __spreadProps(__spreadValues({}, diff), {
      ...
      const insertRows = (index, gridA, gridB, generator, comparator) => {
        ...
        const secondDelta = __spreadProps(__spreadValues({}, secondDiff), {
      ...
      const ColumnContext = __spreadValues({}, adt$6);
      ...
      const copyRows = (table2, target, generators) => {
        ...
        return details.bind((selectedCells) => {
          ...
          const filteredGrid = bind$2(slicedGrid, (row2) => {
            ...
            return newCells.length > 0 ? [__spreadProps(__spreadValues({}, row2), {
              cells: newCells
            })] : [];
          });
      ...
      const Size = __spreadProps(__spreadValues({}, adt$5), {
        from
      });
      ...
      const BeforeAfter = __spreadProps(__spreadValues({}, adt$2), {
        verify,
        cata
      });
