    ...
    setup(props, { slots }) {
        ...
        function scrollPickerColumns(value) {
            ...
            if (monthScrollRef) {
                ...
                monthScrollRef.scrollTo({ top: monthIndex * config_1.MONTH_ITEM_HEIGHT });
            }
            if (yearScrollRef) {
        ...
        function openCalendar() {
            ...
            if (type === 'month' || type === 'year' || type === 'quarter') {
                void (0, vue_1.nextTick)(scrollPickerColumns);
            }
        }
