...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const { mergedClsPrefixRef, mergedThemeRef } = (0, vue_1.inject)(NotificationProvider_1.notificationProviderInjectionKey);
        return {
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { class: [
            ...
            this.showAvatar ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-notification__avatar` }, this.avatar ? ((0, _utils_1.render)(this.avatar)) : this.type !== 'default' ? ((0, vue_1.h)(_internal_1.NBaseIcon, { clsPrefix: mergedClsPrefix }, { default: () => iconMap[this.type] })) : null)) : null,
