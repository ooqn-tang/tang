...
const styles_5 = require("../back-top/styles");
const styles_6 = require("../badge/styles");
const styles_7 = require("../breadcrumb/styles");
const styles_8 = require("../button/styles");
const styles_9 = require("../calendar/styles");
const styles_10 = require("../card/styles");
const styles_11 = require("../carousel/styles");
const styles_12 = require("../cascader/styles");
const styles_13 = require("../checkbox/styles");
const styles_14 = require("../code/styles");
const styles_15 = require("../collapse/styles");
const styles_16 = require("../collapse-transition/styles");
const styles_17 = require("../color-picker/styles");
const styles_18 = require("../data-table/styles");
const styles_19 = require("../date-picker/styles");
const styles_20 = require("../descriptions/styles");
const styles_21 = require("../dialog/styles");
const styles_22 = require("../divider/styles");
const styles_23 = require("../drawer/styles");
const styles_24 = require("../dropdown/styles");
const styles_25 = require("../dynamic-input/styles");
const styles_26 = require("../dynamic-tags/styles");
const styles_27 = require("../element/styles");
const styles_28 = require("../ellipsis/styles");
const styles_29 = require("../empty/styles");
...
exports.lightTheme = {
    ...
    BackTop: styles_5.backTopLight,
    Badge: styles_6.badgeLight,
    Breadcrumb: styles_7.breadcrumbLight,
    Button: styles_8.buttonLight,
    Calendar: styles_9.calendarLight,
    Card: styles_10.cardLight,
    Carousel: styles_11.carouselLight,
    Cascader: styles_12.cascaderLight,
    Checkbox: styles_13.checkboxLight,
    Code: styles_14.codeLight,
    Collapse: styles_15.collapseLight,
    CollapseTransition: styles_16.collapseTransitionLight,
    ColorPicker: styles_17.colorPickerLight,
    DataTable: styles_18.dataTableLight,
    DatePicker: styles_19.datePickerLight,
    Descriptions: styles_20.descriptionsLight,
    Dialog: styles_21.dialogLight,
    Divider: styles_22.dividerLight,
    Drawer: styles_23.drawerLight,
    Dropdown: styles_24.dropdownLight,
    DynamicInput: styles_25.dynamicInputLight,
    DynamicTags: styles_26.dynamicTagsLight,
    Element: styles_27.elementLight,
    Empty: styles_29.emptyLight,
    Ellipsis: styles_28.ellipsisLight,
