...
const backTopProps = Object.assign(Object.assign({}, _mixins_1.useTheme.props), { show: {
    ...
    target: {
        type: Function,
        validator: () => {
            (0, _utils_1.warn)('back-top', '`target` is deprecated, please use `listen-to` instead.');
            return true;
        },
        default: undefined
    }, onShow: {
        type: Function,
        validator: () => {
            (0, _utils_1.warn)('back-top', '`on-show` is deprecated, please use `on-update:show` instead.');
            return true;
        },
        default: undefined
    }, onHide: {
        type: Function,
        validator: () => {
            (0, _utils_1.warn)('back-top', '`on-hide` is deprecated, please use `on-update:show` instead.');
            return true;
        },
        default: undefined
    } });
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const themeRef = (0, _mixins_1.useTheme)('BackTop', 'BackTop', index_cssr_1.default, styles_1.backTopLight, props, mergedClsPrefixRef);
        function init() {
            var _a;
