...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const themeRef = (0, _mixins_1.useTheme)('InputNumber', 'InputNumber', input_number_cssr_1.default, styles_1.inputNumberLight, props, mergedClsPrefixRef);
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-input-number` },
            (0, vue_1.h)(input_1.NInput, { ref: "inputInstRef", bordered: this.mergedBordered, loading: this.loading, value: this.displayedValue, onUpdateValue: this.handleUpdateDisplayedValue, theme: this.mergedTheme.peers.Input, themeOverrides: this.mergedTheme.peerOverrides.Input, builtinThemeOverrides: this.inputThemeOverrides, size: this.mergedSize, placeholder: this.mergedPlaceholder, disabled: this.mergedDisabled, readonly: this.readonly, textDecoration: this.displayedValueInvalid ? 'line-through' : undefined, onFocus: this.handleFocus, onBlur: this.handleBlur, onKeydown: this.handleKeyDown, onMousedown: this.handleMouseDown, onClear: this.handleClear, clearable: this.clearable, internalLoadingBeforeSuffix: true }, {
                _: 2,
