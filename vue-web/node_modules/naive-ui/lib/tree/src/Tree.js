...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const displayTreeMateRef = props.internalDisplayTreeMate
            ...
            : (0, vue_1.computed)(() => (0, treemate_1.createTreeMate)(props.data, createTreeMateOptions(props.keyField, props.childrenField)));
        ...
        const controlledHighlightKeySetRef = (0, vue_1.toRef)(props, 'internalHighlightKeySet');
        ...
        return Object.assign({ mergedClsPrefix: mergedClsPrefixRef, mergedTheme: themeRef, fNodes: mergedFNodesRef, aip: aipRef, selfElRef,
            ...
            getScrollContent,
            handleAfterEnter,
            handleResize, cssVars: (0, vue_1.computed)(() => {
    ...
    render() {
        ...
        if (this.virtualScroll) {
            ...
            return ((0, vue_1.h)(_internal_1.NxScrollbar, { ref: "scrollbarInstRef", onDragleave: draggable ? this.handleDragLeaveTree : undefined, container: this.getScrollContainer, content: this.getScrollContent, class: treeClass, theme: mergedTheme.peers.Scrollbar, themeOverrides: mergedTheme.peerOverrides.Scrollbar, tabindex: tabindex, onKeyup: mergedFocusable ? handleKeyup : undefined, onKeydown: mergedFocusable ? handleKeydown : undefined, onFocusout: mergedFocusable ? handleFocusout : undefined }, {
                default: () => ((0, vue_1.h)(vueuc_1.VVirtualList, { ref: "virtualListInstRef", items: this.fNodes, itemSize: ITEM_SIZE, ignoreItemResize: this.aip, paddingTop: padding.top, paddingBottom: padding.bottom, style: [
                        this.cssVars,
                        {
