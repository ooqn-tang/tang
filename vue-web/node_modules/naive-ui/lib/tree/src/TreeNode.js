...
const TreeNode = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        return {
            ...
            highlight: (0, vooks_1.useMemo)(() => NTree.highlightKeySetRef.value.has(props.tmNode.key)),
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", Object.assign({ class: `${clsPrefix}-tree-node-wrapper` }, dragEventHandlers),
            (0, vue_1.h)("div", { class: [
                ...
                (0, vue_1.h)(TreeNodeContent_1.default, { ref: "contentInstRef", clsPrefix: clsPrefix, checked: checked, selected: selected, onClick: blockLine || disabled ? undefined : this.handleContentClick, onDragstart: draggable && !blockLine && !disabled
                        ? this.handleDragStart
