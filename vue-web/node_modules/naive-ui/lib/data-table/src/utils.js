...
function createCustomWidthStyle(column) {
    const width = (0, seemly_1.pxfy)(getColWidth(column));
    return {
        width,
        minWidth: width
    };
