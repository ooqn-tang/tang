...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        (0, _utils_1.useInjectionInstanceCollection)(interface_1.formItemInstsInjectionKey, 'formItems', (0, vue_1.toRef)(props, 'path'));
        ...
        const mergedDisabledRef = NForm
            ...
            : (0, vue_1.ref)(false);
        const themeRef = (0, _mixins_1.useTheme)('Form', 'FormItem', form_item_cssr_1.default, styles_1.formLight, props, mergedClsPrefixRef);
        ...
        return ((0, vue_1.h)("div", { class: [
            ...
            mergedShowLabel && (this.label || $slots.label) ? ((0, vue_1.h)("label", Object.assign({}, this.labelProps, { class: [
                ...
                mergedRequireMarkPlacement !== 'left'
                    ? (0, vue_1.renderSlot)($slots, 'label', undefined, () => [this.label])
                    : null,
