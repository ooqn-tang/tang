...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const mergedThemeRef = (0, _mixins_1.useTheme)('CollapseTransition', 'CollapseTransition', index_cssr_1.default, styles_1.collapseTransitionLight, props);
    ...
    render() {
        return ((0, vue_1.h)(_internal_1.NFadeInExpandTransition, { appear: this.appear }, {
            default: () => this.mergedShow
                ? (0, vue_1.h)('div', // Don't use jsx since it would cause useless spread in each rendering
                (0, vue_1.mergeProps)({
