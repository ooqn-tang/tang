...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
         } = (0, vue_1.inject)(LoadingBarProvider_1.loadingBarProviderInjectionKey);
        ...
        const themeRef = (0, _mixins_1.useTheme)('LoadingBar', 'LoadingBar', index_cssr_1.default, styles_1.loadingBarLight, providerProps, mergedClsPrefixRef);
        return {
    ...
    render() {
        ...
        return ((0, vue_1.h)(vue_1.Transition, { name: "fade-in-transition", appear: true, onEnter: this.handleEnter, onAfterEnter: this.handleAfterEnter, onAfterLeave: this.handleAfterLeave, css: !this.transitionDisabled }, {
            default: () => (0, vue_1.withDirectives)((0, vue_1.h)("div", { class: `${mergedClsPrefix}-loading-bar-container` },
