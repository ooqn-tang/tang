        ...
        return ((0, vue_1.h)("div", { class: [
            ...
            showIcon && mergedIconPlacement === 'top' ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-dialog-icon-container` },
                (0, vue_1.h)(_internal_1.NBaseIcon, { clsPrefix: mergedClsPrefix, class: `${mergedClsPrefix}-dialog__icon` }, {
                    default: () => (0, vue_1.renderSlot)($slots, 'icon', undefined, () => [
                        this.icon ? (0, _utils_1.render)(this.icon) : iconMap[this.type]
                    ])
                }))) : null,
            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-dialog__title` },
                ...
                (0, vue_1.renderSlot)($slots, 'header', undefined, () => [(0, _utils_1.render)(title)])),
            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-dialog__content` }, (0, vue_1.renderSlot)($slots, 'default', undefined, () => [(0, _utils_1.render)(content)])),
