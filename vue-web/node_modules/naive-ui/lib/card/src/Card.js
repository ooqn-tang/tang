...
exports.default = (0, vue_1.defineComponent)({
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", { class: [
            ...
            $slots.cover ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-card-cover`, role: "none" }, (0, vue_1.renderSlot)($slots, 'cover'))) : null,
            $slots.header || this.title || this.closable ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-card-header`, style: this.headerStyle },
                (0, vue_1.h)("div", { class: `${mergedClsPrefix}-card-header__main`, role: "heading" }, (0, vue_1.renderSlot)($slots, 'header', {}, () => [this.title])),
                $slots['header-extra'] ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-card-header__extra` }, (0, vue_1.renderSlot)($slots, 'header-extra'))) : null,
            ...
            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-card__content`, style: this.contentStyle, role: "none" }, $slots),
            $slots.footer ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-card__footer`, style: this.footerStyle, role: "none" }, (0, vue_1.renderSlot)($slots, 'footer'))) : null,
            $slots.action ? ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-card__action`, role: "none" }, (0, vue_1.renderSlot)($slots, 'action'))) : null));
    }
});
