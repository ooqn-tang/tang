...
export default defineComponent({
    ...
    render() {
        ...
        return (h("div", { class: `${mergedClsPrefix}-message-wrapper`, onMouseenter: this.onMouseenter, onMouseleave: this.onMouseleave, style: Object.assign({
                alignItems: this.placement.startsWith('top')
                    ? 'flex-start'
                    : 'flex-end'
            }, cssVars) }, renderMessage ? (renderMessage(this.$props)) : (h("div", { class: `${mergedClsPrefix}-message ${mergedClsPrefix}-message--${type}-type` },
