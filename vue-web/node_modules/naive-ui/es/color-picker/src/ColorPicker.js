import { h, defineComponent, ref, computed, toRef, watchEffect, withDirectives, Transition, provide, watch, nextTick, renderSlot } from 'vue';
...
export const colorPickerInjectionKey = Symbol('colorPickerThemeInjection');
