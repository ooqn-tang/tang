...
export declare const tabPaneProps: {
    /** @deprecated */
    readonly label: {
        readonly type: PropType<string | number | VNode<import("vue").RendererNode, import("vue").RendererElement, {
            [key: string]: any;
        }> | (() => VNodeChild)>;
...
declare const _default: import("vue").DefineComponent<{
    ...
    label?: string | number | VNode<import("vue").RendererNode, import("vue").RendererElement, {
        [key: string]: any;
    }> | (() => VNodeChild) | undefined;
    tab?: string | number | VNode<import("vue").RendererNode, import("vue").RendererElement, {
        [key: string]: any;
    }> | (() => VNodeChild) | undefined;
