...
declare const _default: import("vue").DefineComponent<{
    ...
    mergedTheme: import("vue").Ref<{
        common: {
            ...
            scrollbarBorderRadius: string; /** I haven't figure out its usage, so just leave it here */
        ...
        peers: {
            Button: import("../../_mixins").Theme<"Button", {
                ...
                textColorInfo: string; /** I haven't figure out its usage, so just leave it here */
