...
public class DtsArticleService {
  ...
  public Page<DtsArticleDto> search(
    String title,
    Integer page,
    Integer pageSize
  ) {
  ...
  public Page<DtsArticleDto> selectArticleByAuthorName(
    String username,
    Pageable pageable
  ) {
  ...
  public DtsArticle updateArticle(DtsArticle article, String subjectId) {
    ...
    DtsArticleSubjectRelevance articleSubjectRelevance = subjectRelevanceRepository.findByArticleId(
  ...
  public DtsArticleSubjectRelevance saveSubjectId(
    String articleId,
    String subjectId
  ) {
  ...
  public Page<DtsArticleDto> selectGzArticleList(
    Pageable pageable,
    String authorId
  ) {
