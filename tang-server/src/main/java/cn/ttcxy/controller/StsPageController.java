...
public class StsPageController {
  ...
  public String toIndex(
    ...
    Page<DtsArticleDto> dtsArticleDtoPageInfo = articleService.selectArticleListSmall(
      pageable
    );
  ...
  public String toArticle(@PathVariable("id") String id, Model model) {
    ...
    if (subjectId != null) {
      DtsArticleSubjectDto selectSubjectArticleListById = articleSubjectService.findSubjectArticleListBySubjectId(
        subjectId
      );
  ...
  public String map(
    ...
    Page<DtsArticleDto> dtsArticleDtoPage = articleService.selectArticleList(
      pageable
    );
  ...
  public String subject(@PathVariable("id") String id, Model model) {
    DtsArticleSubjectDto dtsArticleSubjectDto = articleSubjectService.findSubjectArticleListBySubjectId(
      id
    );
  ...
  public String subjects(
    ...
    Pageable pageable = PageRequest.of(page, 50);
    Page<DtsArticleSubjectDto> dtsArticleSubjectDtoPageInfo = articleSubjectService.selectSubjectList(
      pageable
    );
