...
(function() {
  ...
  MT('image',
      'An images: [string !http://www.example.com/images.png!]');

  MT('imageWithAltText',
      'An images: [string !http://www.example.com/images.png (Alt Text)!]');

  MT('imageWithUrl',
      'An images: [string !http://www.example.com/images.png!:http://www.example.com/]');
