        ...
        <div class="card ">
          <div class="card-body">
            <div class="input-group">
              <textarea v-model="form.text" class="form-control" rows="3" placeholder="输入的内容不包含标签的内容会在最后追加标签中的内容。"
            ...
            <div class="row">
              <div class="col-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                  class="bi bi-chat-dots tag" viewBox="0 0 16 16">
                  <path
              ...
              <div class="col-4" style="text-align: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                  class="bi bi-balloon-heart tag" viewBox="0 0 16 16">
              ...
              <div class="col-4" style="text-align: right;">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                  class="bi bi-cursor tag" viewBox="0 0 16 16">
                  <path
...
function loadEssay() {
  loadEssayApi({ page: page.number }).then((res) => {
    page = res.data;
...
function insertEssay() {
  insertEssayApi(form.value).then((res) => {
    form.value.text = '';
